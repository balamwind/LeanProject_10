...
public:
	...
	UFUNCTION(BlueprintCallable, Category="MyIDPlugin")
	static void SetUserNameWithSubSystem(UUserDataSubSystem* UserDataSubSystem, const FString& NewName);
	
	UFUNCTION(BlueprintPure, Category="MyIDPlugin")
	static FString GetUserName();
	
	UFUNCTION(BlueprintPure, Category="MyIDPlugin")
	static FString GetUserNameWithSubSystem(UUserDataSubSystem* UserDataSubSystem);
